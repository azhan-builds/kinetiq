  ...
  return (
    <div className="site-wrapper">
      ...
      <main className="page-two-sheet blog-page-sheet" style={{ paddingTop: '110px' }}>
        <section className="section-block blog-section" style={{ minHeight: 'calc(100vh - 200px)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          <div className="blog-container">
            ...
            >
              <h1 className="blog-coming-soon-statement">
